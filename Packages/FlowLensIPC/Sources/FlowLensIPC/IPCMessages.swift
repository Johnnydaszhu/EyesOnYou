...
public enum FlowLensConstants {
    public static let appGroupIdentifier = "group.com.example.FlowLens"
    public static let machServiceName = "com.example.FlowLens.xpc"
    public static let hostBundleID = "com.example.FlowLens"
    public static let extensionBundleID = "com.example.FlowLens.NetworkExtension"
}
